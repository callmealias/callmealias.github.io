...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center" style={{
      ...
      <div className="container relative z-10 mx-auto px-4 text-center flex flex-col h-full">
        {/* Moved name to top third of screen with extra top padding */}
        ...
        {/* Rest of content in middle/bottom portion */}
