  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center" style={{
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        >
          <Link href="/#resume" className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300">
            View Resume
          </Link>
          <Link href="/#projects" className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300">
            Explore Projects
          </Link>
          <Link href="/#contact" className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300">
            Contact
          </Link>
        </motion.div>
